...
console.log(programming["languages"][3]) // expected output: "Go"


// Change the difficulty to the value of 7.
programming["difficulty"] = 7
console.log(programming["difficulty"]) // expected output: 7

// Using the delete keyword, write the command to remove the jokes key from the programming object.
delete programming["jokes"] 
console.log(programming["jokes"]) // expected output: undefined

// Write the command to add a new key called isFun and a value of true to the programming object.
programming["isFun"] = true
console.log(programming["isFun"]) // expected output: true


// Using a loop, iterate through the languages array and console.log all of the languages.
for(let prop in programming){
  if(prop === "languages"){
    for(let i = 0; i < programming[prop].length; i++){
      console.log(programming[prop][i])
    }
  }
}
